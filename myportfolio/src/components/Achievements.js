    ...
    return (
        <div name="ach">
			...
			<div className="main-content">
				...
				<div className="col-md-3 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
				...
				<div className="col-md-3 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
					<div className="ach-entry">
							<div className="desc">
							<span><small>October, 2019 </small></span>
							<h4><a className="desc-one">Esteemed International Student Scholarship</a></h4>
							<p>Awarded OMIS Esteemed International Student Scholarship for the Fall 2019</p>
						</div>
					</div>
					</div>			
					<div className="col-md-3 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
					<div className="ach-entry">
							...
							<h4><a className="desc-four">Award of ‘Best Performer’</a></h4>
							<p>Awarded during first quarter 2018, by Systems Integration Head, Prolifics Inc.</p>
						</div>
					</div>
					</div>
					<div className="col-md-3 col-sm-6 animate-box" data-animate-effect="fadeInBottom">
					<div className="ach-entry">
						<div className="desc">
